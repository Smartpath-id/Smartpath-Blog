...
const Navbars = () => {
  ...
  return (
    <nav className="fixed top-0 z-30 w-full py-1 px-12 shadow-xl bg-white">
    <div>
      <div className={`${flexBetween} mx-auto w-full`}>
        <div className={`${flexBetween} w-full gap-20 font-poppins`}>
          {/* BAGIAN KIRI */}
          <Link href={`${process.env.NEXT_PUBLIC_URL_USER}`}>
            <img
              src={Logo.src}
              alt="logo smartpath"
              className="w-[150px] 2xl:w-[170px]"
            ></img>
          </Link>
          {/* <p>LOGO</p> */}
              ...
              <div className={`${flexBetween}`}>
                <ul className="flex w-full gap-8">
                  <li className={`${flexBetween}`}>
                    <Link href={`${process.env.NEXT_PUBLIC_URL_USER}`} className="hover:text-gray">
                      Home
                    </Link>
                  </li>
                  <li
                  ...
                  <li
                    ...
                    // onMouseLeave={toggleDropdown}
                  >
                    <Link href={`${process.env.NEXT_PUBLIC_URL_USER}/live-course`} className="flex-auto">
                      Live Course
                      {isDropdownOpen && (
                        <div className="absolute w-72 bg-white border-gray-200 rounded-lg shadow-lg hidden group-hover:flex">
                          <ul>
                  ...
                  <li
                    ...
                    // onMouseLeave={toggleDropdown}
                  >
                    <Link href={process.env.NEXT_PUBLIC_URL_EVENT} className="flex-auto">
                      Event
                      {isDropdownOpen && (
